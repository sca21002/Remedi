...
Helper::prepare_input_files({
    ...
    copy => [ qw(ubr12226_0001.tif ubr12226.pdf  log4perl.conf) ],
});
...
my $pdf = Remedi::Singlepage::PDF::FromPDF->new(
    ...
    image => Remedi::Imagefile->new(
        ...
        isil => 'DE-355',
        file => path($Bin, qw(input_files ubr12226_0001.tif)),
    ...
    source_pdf  => Remedi::PDF::API2->open(file =>
        path($Bin, qw(input_files ubr12226.pdf))->stringify
    ),
    title => 'Titel',
    page_num    => 1,
    pages_total => 3,
...
is($pdf->filestem,'ubr12226_0001','filestem');
