...
Helper::prepare_input_files({
    ...
    rmdir_dirs => [ 'archive' ],
    copy => [qw(ubr05302_0001.tif ubr05302.pdf)],
});
...
my $task = Remedi::DigiFooter::App->new(
    ...
    source_format => 'PDF',
    source_pdf_name => path($Bin, qw(input_files ubr05302.pdf))->stringify,
    title => 'Mein Titel',
);
note("may take some time ..");
$task->make_footer;
my $app = Log::Log4perl::Appender::TestBuffer->by_name("my_buffer");
like($app->buffer, qr/Image will be rotated/, 'Image will be rotated');
